...
<div class="container">
    <form action="/vocabulary" method="POST">
        ...
        <div class="d-flex justify-content-between">
            <a href="{{ URL::to('vocabulary') }}" class="btn btn-sm btn-danger text-warning mb-3">
                <i class="fas fa-arrow-left me-2"></i>
                <span>Vocabulary</span>
            </a>
            @if(Auth::check())
            <div class="dropdown">
                <button class="btn btn-sm btn-danger text-warning dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                    Actions
                </button>
        ...
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="meaning" rows="3">{{ old('meaning') }}</textarea>
                </div>
            </div>
        </div>
    </form>
